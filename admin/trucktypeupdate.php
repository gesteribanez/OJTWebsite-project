...
$id=$_GET['id'];
$result = $mysqli -> query("select * from tbl_truck_type WHERE id = '$id'");
								...
								<div class="panel-content">
									<div class="form-row">
										<div class="col-md-12 mb-3">
											...
											<input type="text" autocomplete="off"class="form-control" name="type" id="type" placeholder="Truck Location" value="<?php echo $type ?>" required>
										</div>
									</div>
