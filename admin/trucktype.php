...
<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item">TRUCK TYPE</li>
...
<div class="modal fade" id="addmodal" tabindex="-1" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title h4">Add Truck Type</h5>
								...
								<div class="panel-content">
									<div class="form-row">
										<div class="col-md-12 mb-3">
											<label class="form-label" for="validationCustom01">Truck Type
												<span class="text-danger"></span> </label>
											<input type="text" class="form-control"  autocomplete="off" name="type" id="type" placeholder="Truck Type" required>
										</div>
									</div>
